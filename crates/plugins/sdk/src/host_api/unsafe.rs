...
use crate::abi::{
    ...
    HostPluginModVisitorFn, HostPluginModZipVisitorFn, HostReadMemoryFn,
    HostRegisterFileProviderFn, HostRegisterLuaModuleFn, HostScanMemoryFn, HostWriteMemoryFn,
...
pub(super) fn register_lua_module(
    host_context: *mut c_void,
    register: HostRegisterLuaModuleFn,
