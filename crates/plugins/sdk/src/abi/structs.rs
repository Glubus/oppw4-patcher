...
use super::ffi::{
    ...
    HostGameStatusFn, HostLogFn, HostModuleBaseFn, HostReadMemoryFn, HostRegisterFileProviderFn,
    HostRegisterLuaModuleFn, HostScanMemoryFn, HostWriteMemoryFn, Oppw4LuaRegisterFn,
...
pub struct Oppw4PluginApi {
    ...
    pub register_lua_module: Option<HostRegisterLuaModuleFn>,
